...
class Network:
    ...
    def build_network(self, input_data):
        ...
        network = lasagne.layers.DenseLayer(lasagne.layers.dropout(network, p=.5), num_units=DENSE_UNITS_1, nonlinearity=lasagne.nonlinearities.tanh)
        network = lasagne.layers.DenseLayer(lasagne.layers.dropout(network, p=.5), num_units=DENSE_UNITS_2, nonlinearity=lasagne.nonlinearities.tanh)
