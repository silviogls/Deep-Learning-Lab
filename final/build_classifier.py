...
def main(num_epochs, LR, batch_size=256):
    train_data, train_labels, test_data, test_labels = utils.load_dataset_zipped_supervised(data_path, train_size = .75, network_type = 'convolutional', shuffle=True)
    input_var = T.tensor4('inputs')
    target_var = T.matrix('targets')
    
    print("building the classifier...")
    network = utils.build_classifier(train_data, train_labels, input_var)
...
if __name__ == '__main__':
    ...
    print(data_path)
    main(500, 0.0005, batch_size=256)
