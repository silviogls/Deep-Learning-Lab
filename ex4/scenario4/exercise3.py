...
if __name__ == '__main__':
    ...
    if (iscenario == 5):
        ...
        performance_file = open("PERFORMANCE_REPORT.txt", "w+")
        for ievaluation in range(0, mexevaluations):
            ...
            performance_file.write("nfilters, "+str(nfilters)+"\n")
            performance_file.write("batch_size_train, "+str(batch_size_train)+"\n")
            performance_file.write("M, "+str(M)+"\n")
            performance_file.write("LR, "+str(LR)+"\n")
            performance_file.write("best_val_acc, "+str(best_val_acc)+"\n")
